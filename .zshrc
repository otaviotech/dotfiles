...
alias cdwss="cd $SOURCES_ROOT/kodde/lecom/workspace/workspace-server"
alias cdwsf="cd $SOURCES_ROOT/kodde/lecom/workspace/workspace-web"
alias cdgov="cd $SOURCES_ROOT/kodde/governance/web"
alias cdwsf="cd $SOURCES_ROOT/kodde/workspace-web"
